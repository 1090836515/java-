...
/**
 ...
 9.abstract 只能修饰方法和类，不能修饰字段;抽象方法不能有方法体，即没有括号
 10.抽象类可以继承接口，可以实现接口，也可以继承实体类
 11.抽象方法需要子类重写，而静态的方法是无法被重写的;本地方法是由本地动态库实现的方法，而抽象方法是没有实现的;
 抽象方法没有方法体；synchronized 方法，需要有具体的方法体，相互矛盾(abstract方法不能)
 */
